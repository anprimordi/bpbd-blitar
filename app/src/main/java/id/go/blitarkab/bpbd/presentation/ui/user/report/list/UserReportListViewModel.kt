...
@HiltViewModel
class UserReportListViewModel @Inject constructor(
    @Repository accountDataSource: AccountDataSource,
    @Repository private val reportDataSource: ReportDataSource
) : BaseViewModel(accountDataSource), UserReportListContract.Presenter {
    ...
    override fun loadData() {
        viewModelScope.launch {
            setLoading()
            val result = reportDataSource.getUserReportList()
