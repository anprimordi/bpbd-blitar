...
import id.go.blitarkab.bpbd.databinding.FragmentUserProfileBinding
...
class UserProfileFragment :
    BaseFragment<FragmentUserProfileBinding, UserProfileContract.Presenter>(),
    UserProfileContract.View {

    override val layoutResourceId: Int = R.layout.fragment_user_profile
    override val presenter: UserProfileContract.Presenter by viewModels<UserProfileViewModel>()
    ...
    override fun openProfileDetailPage() {
        val direction = UserProfileFragmentDirections.actionUserProfileFragmentToUserProfileDetailFragment()
    ...
    override fun openAboutPage() {
        val direction = UserProfileFragmentDirections.actionUserProfileFragmentToUserProfileAboutFragment()
        findNavController().navigate(direction)
    }
