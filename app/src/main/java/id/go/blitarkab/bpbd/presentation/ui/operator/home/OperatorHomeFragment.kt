...
import id.go.blitarkab.bpbd.databinding.FragmentOperatorHomeBinding
...
@AndroidEntryPoint
class OperatorHomeFragment :
    BaseFragment<FragmentOperatorHomeBinding, OperatorHomeContract.Presenter>(),
    OperatorHomeContract.View, OnMapReadyCallback {

    override val layoutResourceId: Int = R.layout.fragment_operator_home
    override val presenter: OperatorHomeContract.Presenter by viewModels<OperatorHomeViewModel>()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.mapView.apply {
            ...
            getMapAsync(this@OperatorHomeFragment)
        }
    }
    ...
    override fun openProfileDetailPage() {
        val direction =
            OperatorHomeFragmentDirections.actionOperatorHomeFragmentToOperatorProfileDetailFragment()
        findNavController().navigate(direction)
    }

    override fun openVolcanoPage() {
        val direction =
            OperatorHomeFragmentDirections.actionOperatorHomeFragmentToUserVolcanoFragment2()
        findNavController().navigate(direction)
    }

    override fun openCovidPage() {
        val direction =
            OperatorHomeFragmentDirections.actionOperatorHomeFragmentToUserCovidFragment2()
        findNavController().navigate(direction)
    }

    override fun openEarthQuakePage() {
        val direction =
            OperatorHomeFragmentDirections.actionOperatorHomeFragmentToUserEarthQuakeFragment2()
        findNavController().navigate(direction)
    }

    override fun openSatellitePage() {
        val direction =
            OperatorHomeFragmentDirections.actionOperatorHomeFragmentToUserSatelliteFragment2()
        findNavController().navigate(direction)
    }

    override fun openReportListPage() {
        val direction =
            OperatorHomeFragmentDirections.actionOperatorHomeFragmentToOperatorReportListFragment()
        findNavController().navigate(direction)
    }

    override fun openReportDetailPage(report: Report) {
        val direction =
            OperatorHomeFragmentDirections.actionOperatorHomeFragmentToOperatorReportDetailFragment(
                reportId = report.id,
                readOnly = true
            )
        findNavController().navigate(direction)
    ...
    override fun openNewsPage(news: News) {
        /*val direction =
            OperatorHomeFragmentDirections.actionOperatorHomeFragmentToUserNewsFragment2(news)
        findNavController().navigate(direction)*/
    }
