...
import id.go.blitarkab.bpbd.databinding.FragmentOperatorNewsDetailBinding
import id.go.blitarkab.bpbd.domain.model.News
import id.go.blitarkab.bpbd.domain.model.common.Result
import id.go.blitarkab.bpbd.domain.model.common.Success
import id.go.blitarkab.bpbd.presentation.ui.user.news.UserNewsListAdapter
import id.go.blitarkab.bpbd.presentation.util.base.BaseFragment

@AndroidEntryPoint
class OperatorNewsDetailFragment :
    BaseFragment<FragmentOperatorNewsDetailBinding, OperatorNewsDetailContract.Presenter>(),
    OperatorNewsDetailContract.View {

    override val layoutResourceId: Int = R.layout.fragment_operator_news_detail
    override val presenter: OperatorNewsDetailContract.Presenter by viewModels<OperatorNewsDetailViewModel>()

    private val safeArgs: OperatorNewsDetailFragmentArgs by navArgs()
